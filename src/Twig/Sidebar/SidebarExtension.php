...
class SidebarExtension extends AbstractExtension
{
    ...
    public function __construct(
        ...
        $this->defaultSidebarClass = MainSidebar::class;
    }
    ...
    {
        $sidebar = $this->container->get($sidebarClass === null ? $this->defaultSidebarClass : $sidebarClass);
